...
#define AUX_MQTTSETTING "/bayou_settings"
#define AUX_MQTTSAVE    "/bayou_save"
...
String saveParams(AutoConnectAux& aux, PageArgument& args) {
  ...
  // The entered value is owned by AutoConnectAux of /bayou_setting.
  // To retrieve the elements of /bayou_setting, it is necessary to get
  // the AutoConnectAux object of /bayou_setting.
  File param = SPIFFS.open(PARAM_FILE, "w");
  portal.aux("/bayou_settings")->saveElement(param, { "mqttserver", "channelid", "userkey", "apikey", "period", "uniqueid", "hostname" });
  param.close();
...
"<body>"
  ...
  content += String(F("<p><a class=\"button\" href=\"/_ac/config\">WiFi Settings</a><a class=\"button\" href=\"/bayou_settings\">Bayou Settings</a></p>"));
...
void setup() {
  ...
  if (setting) {
    PageArgument  args;
    AutoConnectAux& bayou_settings = *setting;
    loadParams(bayou_settings, args);
    AutoConnectCheckbox&  uniqueidElm = bayou_settings["uniqueid"].as<AutoConnectCheckbox>();
    AutoConnectInput&     hostnameElm = bayou_settings["hostname"].as<AutoConnectInput>();
